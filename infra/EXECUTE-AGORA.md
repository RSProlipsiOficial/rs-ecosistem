# 🚀 EXECUTE AGORA - Setup VPS RS Prólipsi

## ⚡ AÇÃO IMEDIATA (Cole isso no terminal da VPS)

### 1️⃣ Conecte na VPS pelo VS Code

Pressione `F1` no VS Code → Digite: `Remote-SSH: Connect to Host...`  
Digite: `deploy@72.60.144.245`

### 2️⃣ Verifique o usuário

```bash
whoami
```

Se retornar `root`, execute:

```bash
su - deploy
```

### 3️⃣ Cole este comando COMPLETO no terminal
...
### 4️⃣ Aguarde a instalação (10-15 minutos)

O script vai:

- ✅ Atualizar o sistema
- ✅ Instalar Docker
- ✅ Instalar Node 20 + PNPM
- ✅ Instalar PM2
- ✅ Clonar 15 repositórios
- ✅ Instalar dependências
- ✅ Configurar Git
- ✅ Criar template de .env

### 5️⃣ Após finalizar, execute
...
Depois de executar o setup, consulte:

- **`README-VPS.md`** - Guia de início rápido
- **`VPS-SETUP-GUIDE.md`** - Documentação completa
- **`VPS-CHECKLIST.md`** - Checklist de verificação
- **`vps-helpers.sh`** - Scripts auxiliares
...
### Erro ao clonar repos

Verifique se o PAT está correto no script (linha 32)
