...
const Links: React.FC = () => {
    ...
    const handleCreateLink = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const newLink = {
            ...
            amount: isFixedAmount ? parseFloat((formData.get('amount') as string).replace(/\D/g, '')) : null,
            status: 'active' as 'active' | 'inactive',
            url: `https://rs.wallet/pay/${(formData.get('name') as string).toLowerCase().replace(/\s/g, '-')}`,
