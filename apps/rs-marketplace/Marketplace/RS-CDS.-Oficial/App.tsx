...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-dark-950 min-h-screen text-gray-200 font-sans selection:bg-gold-500 selection:text-black">
      ...
      */}
      <main className="ml-0 md:ml-64 p-4 md:p-8 min-h-screen bg-black/40 transition-all duration-300 flex flex-col">
        {/* Header Content */}
        <header className="flex justify-between items-center mb-6 md:mb-8 pb-4 border-b border-dark-800 sticky top-0 bg-dark-950/90 backdrop-blur z-30 pt-2">
            <div className="flex items-center gap-2 md:gap-4">
                ...
                {viewHistory.length > 1 && (
                    <button 
                      onClick={handleBack}
                      className="p-2 text-rs-gold hover:text-white hover:bg-dark-800 rounded-lg transition-colors flex items-center gap-2 animate-fade-in"
                ...
                <div className="md:hidden text-sm font-bold text-rs-gold uppercase tracking-wider ml-2">
                  RS Prólipsi
                </div>
            </div>
            ...
            <div className="flex items-center gap-3 md:gap-4">
                ...
                <div className="flex items-center gap-3 pl-4 border-l border-dark-800">
                    ...
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-dark-800 border border-rs-gold-50 flex items-center justify-center text-rs-gold overflow-hidden">
