  ...
  return (
    <>
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm w-full justify-end">
        ...
        <div className="flex items-center gap-2">
            <button onClick={() => setCredModalOpen(true)} className="bg-zinc-700 hover:bg-zinc-600 px-3 py-1.5 rounded-md transition-colors">Credenciais</button>
            <button onClick={() => setParamsModalOpen(true)} className="bg-zinc-700 hover:bg-zinc-600 px-3 py-1.5 rounded-md transition-colors">Parâmetros</button>
        </div>
      </div>
