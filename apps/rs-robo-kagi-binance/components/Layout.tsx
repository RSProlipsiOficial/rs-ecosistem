    ...
    return (
        <div className="flex h-screen overflow-hidden">
            ...
            <div className="flex flex-col flex-grow min-w-0">
                <header className={`bg-zinc-900 border-b border-zinc-800 z-20 transition-all duration-300 relative ${isHeaderCollapsed ? 'py-0 h-8' : 'h-auto lg:h-24 py-2 lg:py-0'}`}>
                    ...
                    <div 
                        ...
                        className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-full w-12 h-4 bg-zinc-800 hover:bg-amber-600 rounded-b-md cursor-pointer flex justify-center items-center"
