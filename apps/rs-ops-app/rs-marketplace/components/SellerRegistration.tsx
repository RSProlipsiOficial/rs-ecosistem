...
const SellerRegistration: React.FC<SellerRegistrationProps> = ({
  ...
  const sponsorLabel =
    sponsorSource === 'referral'
      ? `Seu cadastro sera vinculado ao ID ${formData.sponsorId}.`
      : 'Seu cadastro sera vinculado automaticamente a conta principal da RS.';

  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#000000] px-4 py-6 text-white">
        ...
        <div className="overflow-hidden rounded-[2.5rem] border border-white/10 bg-black/80 shadow-2xl backdrop-blur-xl">
          <div className="border-b border-white/5 px-6 pb-8 pt-10 md:px-10">
            <div className="text-center">
              ...
              />
              <p className="mt-3 text-[10px] font-bold uppercase tracking-[0.3em] text-gray-300 opacity-90">
                Cadastro RS Prolipsi
              </p>
              ...
              <p className="mx-auto mt-3 max-w-2xl text-sm text-gray-300 md:text-base">
                Preencha seu cadastro completo para entrar no ecossistema RS Prolipsi ja vinculado a rede correta.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8 p-6 md:p-10">
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start">
              <section className="space-y-5">
                <div>
                  ...
                  <p className="text-xs uppercase tracking-[0.16em] text-gray-300/80">Cadastro principal</p>
                </div>
              ...
              <section className="space-y-5">
                <div>
                  ...
                  <p className="text-xs uppercase tracking-[0.16em] text-gray-300/80">Dados para perfil completo</p>
                </div>
            ...
            <section className="space-y-5">
              <div>
                ...
                <p className="text-xs uppercase tracking-[0.16em] text-gray-300/80">Defina sua senha do ecossistema</p>
              </div>
