...
BEGIN
    ...
    -- E FILTRANDO PARA APENAS MASTER/OWNER (Como pedido por Robert no áudio)
    ...
    -- Active Subscriptions count (Ativas): Exclui trial e filtra por tipo de venda
...
async function apply() {
    try {
        ...
        console.log('✅ RPC get_admin_billing_summary atualizada com filtro rigoroso de Master/Owner!');
    } catch (err) {
