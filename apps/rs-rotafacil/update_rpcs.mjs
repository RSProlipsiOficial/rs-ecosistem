...
const sql = `
-- Atualizar a RPC de busca de aluno para incluir novos campos
...
-- Atualizar a RPC de atualização para suportar os novos campos
...
async function applyRPCS() {
    ...
    try {
        ...
        console.log("RPCs atualizadas com sucesso!");
    } catch (err) {
