...
import { User, MapPin, Phone, CreditCard, CheckCircle2, AlertCircle, ArrowLeft, Bus, X, QrCode, FileText, PenTool, MessageCircle } from "lucide-react";
...
export default function PublicCadastro() {
    ...
    const [branding, setBranding] = useState<{ logo_url?: string; company_name: string }>(() => {
        ...
        return { company_name: "RS Prólipsi" };
    });
                ...
                <Card className="max-w-lg w-full border-gold/50 bg-black-secondary shadow-2xl shadow-gold/10">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-3 pt-4 border-t border-gold/20">
                            ...
                            {/* Botão WhatsApp Group - NOVO */}
                            {(() => {
                                const selectedVan = registrationData?.vans.find((v: any) => v.id === formData.van_id);
                                if (selectedVan?.link_grupo_whatsapp) {
                                    return (
                                        <Button
                                            onClick={() => window.open(selectedVan.link_grupo_whatsapp, '_blank')}
                                            className="w-full h-14 bg-[#25D366] hover:bg-[#128C7E] text-white font-bold text-lg shadow-lg hover:shadow-[#25D366]/20 transition-all flex items-center justify-center gap-3 animate-in fade-in slide-in-from-bottom-2"
                                        >
                            ...
                            <Button
                                ...
                                className="w-full h-14 bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-700 hover:to-emerald-800 text-white font-bold text-lg shadow-lg"
                            >
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="relative">
                                                    <select
                                                        id="nome_colegio"
                                                        required
                                                        className="h-10 w-full rounded-md border border-gold/30 bg-dark-lighter px-3 py-2 text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 text-white font-medium shadow-sm transition-all"
                                                        style={{
                                                            background: '#1a1b23',
                                                            color: '#ffffff',
                                                            appearance: 'auto'
                                                    ...
                                                    >
                                                        <option value="" disabled style={{ background: '#1a1b23', color: '#9ca3af' }}>
                                                            {colegiosLoading
                                                                ? "Carregando..."
                                                                : !formData.van_id
                                                                    ? "Selecione uma van primeiro"
                                                                    : colegios.length === 0
                                                                        ? "Nenhum colégio atendido por esta van."
                                                                        : "Selecione o colégio"}
                                                        </option>
                                                        {colegios.map(school => (
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <select
                                                    id="turno"
                                                    className="h-10 w-full rounded-md border border-gold/30 bg-dark-lighter px-3 py-2 text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 text-white font-medium"
                                                    style={{
                                                        background: '#1a1b23',
                                                        color: '#ffffff'
                                                    }}
