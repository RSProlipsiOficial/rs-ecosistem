            ...
            <div className={cn(
                ...
                {!collapsed && (
                    <div className="mt-auto border-t border-border/50 p-4 bg-black/20 animate-in fade-in duration-500">
                        ...
                        <div id="pwa-install-container-monitora" className="mt-4 hidden animate-in fade-in slide-in-from-bottom-2 duration-500">
                            <Button
                                variant="default"
                                    ...
                                    if (prompt) {
                                        ...
                                        prompt.userChoice.then((choice: any) => {
                                            if (choice.outcome === 'accepted') {
                                                document.getElementById('pwa-install-container-monitora')?.classList.add('hidden');
                                            }
                                        });
                                    }
                                }}
                        ...
                        <script dangerouslySetInnerHTML={{
                            ...
                            window.addEventListener('beforeinstallprompt', (e) => {
                                document.getElementById('pwa-install-container-monitora')?.classList.remove('hidden');
                            });
